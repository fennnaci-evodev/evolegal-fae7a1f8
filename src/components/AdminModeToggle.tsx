...
export function AdminModeToggle() {
  ...
  return (
    <button
      onClick={toggleMode}
      className="cyber-button cyber-ghost flex items-center gap-2 px-3 py-1.5 group"
      title={`Switch to ${isAdminMode ? "User" : "Admin"} Mode`}
    >
      <div className="relative w-9 h-5 rounded-full bg-muted/60 border border-border/40">
        <motion.div
      ...
      <motion.span
        ...
        style={{
          color: isAdminMode ? "hsl(var(--primary))" : "currentColor",
        }}
      >
