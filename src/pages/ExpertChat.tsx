    ...
    <DashboardLayout>
      <div className="h-[calc(100vh-6rem)] flex gap-3">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          >
            <HugoAvatar size={isMobile ? 36 : 47} />
          ...
          <div className="flex-1 overflow-y-auto space-y-3 pr-2 mb-3" style={{ overflowAnchor: "none" }}>
            ...
            <AnimatePresence>
              {messages.map((msg) => (
                ...
                >
                  {msg.role === "assistant" && <HugoAvatar size={42} animate={false} talking={streaming && msg.id === messages[messages.length - 1]?.id} />}
            ...
            {streaming && messages[messages.length - 1]?.role === "user" && (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex gap-3 items-center">
                <HugoAvatar size={42} animate={false} talking />
